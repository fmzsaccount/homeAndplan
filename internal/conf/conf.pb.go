...
type Bootstrap struct {
	...
	Zaplog *Log    `protobuf:"bytes,3,opt,name=zaplog,proto3" json:"zaplog,omitempty"`
}
...
func (x *Bootstrap) GetZaplog() *Log {
	if x != nil {
		return x.Zaplog
	}
	return nil
...
type Server struct {
	...
	Other *Server_Other `protobuf:"bytes,3,opt,name=other,proto3" json:"other,omitempty"`
}
...
func (x *Server) GetOther() *Server_Other {
	if x != nil {
		return x.Other
	}
	return nil
...
type Log struct {
	...
	Kafka *Log_Kafka `protobuf:"bytes,1,opt,name=kafka,proto3" json:"kafka,omitempty"`
	Sys   *Log_Sys   `protobuf:"bytes,2,opt,name=sys,proto3" json:"sys,omitempty"`
}
...
func (x *Server_Other) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_Other) ProtoMessage() {}

func (x *Server_Other) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_Other.ProtoReflect.Descriptor instead.
func (*Server_Other) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{1, 2}
}

func (x *Server_Other) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *Server_Other) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Server_Other) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
type Log_Kafka struct {
	...
	Broker       []string             `protobuf:"bytes,1,rep,name=broker,proto3" json:"broker,omitempty"`
	Topic        string               `protobuf:"bytes,2,opt,name=topic,proto3" json:"topic,omitempty"`
	WriteTimeout *durationpb.Duration `protobuf:"bytes,3,opt,name=writeTimeout,proto3" json:"writeTimeout,omitempty"`
	Async        bool                 `protobuf:"varint,4,opt,name=async,proto3" json:"async,omitempty"`
}

func (x *Log_Kafka) Reset() {
	*x = Log_Kafka{}
	if protoimpl.UnsafeEnabled {
...
func (x *Log_Kafka) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Log_Kafka) ProtoMessage() {}

func (x *Log_Kafka) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Log_Kafka.ProtoReflect.Descriptor instead.
func (*Log_Kafka) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Log_Kafka) GetBroker() []string {
	if x != nil {
		return x.Broker
	}
	return nil
...
func (x *Log_Kafka) GetTopic() string {
	if x != nil {
		return x.Topic
	}
	return ""
...
func (x *Log_Kafka) GetWriteTimeout() *durationpb.Duration {
	if x != nil {
		return x.WriteTimeout
	}
	return nil
...
func (x *Log_Kafka) GetAsync() bool {
	if x != nil {
		return x.Async
	}
	return false
...
func (x *Log_Sys) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Log_Sys) ProtoMessage() {}

func (x *Log_Sys) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[10]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Log_Sys.ProtoReflect.Descriptor instead.
func (*Log_Sys) Descriptor() ([]byte, []int) {
	return file_internal_conf_conf_proto_rawDescGZIP(), []int{3, 1}
}

func (x *Log_Sys) GetAppid() int32 {
	if x != nil {
		return x.Appid
	}
	return 0
...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x27, 0x0a, 0x06, 0x7a, 0x61, 0x70, 0x6c, 0x6f, 0x67,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x06, 0x7a, 0x61, 0x70, 0x6c, 0x6f, 0x67, 0x22,
	0xd4, 0x03, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x04, 0x68, 0x74,
	...
	0x67, 0x72, 0x70, 0x63, 0x12, 0x2e, 0x0a, 0x05, 0x6f, 0x74, 0x68, 0x65, 0x72, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69,
	0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x4f, 0x74, 0x68, 0x65, 0x72, 0x52, 0x05, 0x6f,
	0x74, 0x68, 0x65, 0x72, 0x1a, 0x69, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50, 0x12, 0x18, 0x0a, 0x07,
	...
	0x6e, 0x52, 0x07, 0x74, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x1a, 0x6a, 0x0a, 0x05, 0x4f, 0x74,
	0x68, 0x65, 0x72, 0x12, 0x18, 0x0a, 0x07, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x18, 0x01,
	...
	0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0xb7, 0x03, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12,
	...
	0x1a, 0x8d, 0x02, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x6e, 0x65,
	...
	,
	...
	0x6f, 0x75, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x61, 0x73, 0x79, 0x6e, 0x63, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x05, 0x61, 0x73, 0x79, 0x6e, 0x63, 0x1a, 0x2d, 0x0a, 0x03, 0x53, 0x79, 0x73,
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x65, 0x6e, 0x76, 0x42, 0x1c, 0x5a, 0x1a, 0x67, 0x79, 0x5f, 0x68,
	0x6f, 0x6d, 0x65, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x63, 0x6f, 0x6e,
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	11, // 12: kratos.api.Server.Other.timeout:type_name -> google.protobuf.Duration
	...
	11, // 16: kratos.api.Log.Kafka.writeTimeout:type_name -> google.protobuf.Duration
