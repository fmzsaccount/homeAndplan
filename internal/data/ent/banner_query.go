...
func (bq *BannerQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (bq *BannerQuery) FirstIDX(ctx context.Context) int32 {
...
func (bq *BannerQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (bq *BannerQuery) OnlyIDX(ctx context.Context) int32 {
...
func (bq *BannerQuery) IDs(ctx context.Context) ([]int32, error) {
	var ids []int32
...
func (bq *BannerQuery) IDsX(ctx context.Context) []int32 {
	ids, err := bq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (bgb *BannerGroupBy) sqlScan(ctx context.Context, v any) error {
...
func (bs *BannerSelect) sqlScan(ctx context.Context, v any) error {
