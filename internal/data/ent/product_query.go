...
type ProductQuery struct {
	...
	withParentID *ProductCategoryQuery
...
// QueryParentID chains the current query on the "parent_id" edge.
func (pq *ProductQuery) QueryParentID() *ProductCategoryQuery {
...
func (pq *ProductQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (pq *ProductQuery) FirstIDX(ctx context.Context) int32 {
...
func (pq *ProductQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (pq *ProductQuery) OnlyIDX(ctx context.Context) int32 {
...
func (pq *ProductQuery) IDs(ctx context.Context) ([]int32, error) {
	var ids []int32
...
func (pq *ProductQuery) IDsX(ctx context.Context) []int32 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *ProductQuery) Clone() *ProductQuery {
	...
	return &ProductQuery{
		...
		withParentID: pq.withParentID.Clone(),
...
// WithParentID tells the query-builder to eager-load the nodes that are connected to
// the "parent_id" edge. The optional arguments are used to configure the query builder of the edge.
func (pq *ProductQuery) WithParentID(opts ...func(*ProductCategoryQuery)) *ProductQuery {
	query := &ProductCategoryQuery{config: pq.config}
	for _, opt := range opts {
		opt(query)
	}
	pq.withParentID = query
	return pq
}
...
func (pq *ProductQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Product, error) {
	...
	if query := pq.withParentID; query != nil {
		if err := pq.loadParentID(ctx, query, nodes, nil,
			func(n *Product, e *ProductCategory) { n.Edges.ParentID = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *ProductQuery) loadParentID(ctx context.Context, query *ProductCategoryQuery, nodes []*Product, init func(*Product), assign func(*Product, *ProductCategory)) error {
	ids := make([]int32, 0, len(nodes))
	nodeids := make(map[int32][]*Product)
	for i := range nodes {
